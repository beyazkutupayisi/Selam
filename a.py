...
class Zefoy:
        ...
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                while time.time()-2<_+zyfoy:
                    t-=1
                    print(" - \033[1;31mBekle:\033[1;36m {0} ".format(t)+"\033[1;35mSaniye\033[1;32m .", end="\r")
    ...
    def use_service(self):
        ...
        if 'Session expired. Please re-login' in res:
            print('Oturum süresi doldu. Tekrar giriş yapıyorum...')
            self.send_captcha()
            return ""
...
#thomas
    def select_service(self):
        while True:
            ...
            print("\x1b[1;39m—" * 60)
            print(f"""\x1b[38;5;117m1\x1b[38;5;231m - Tiktok Takipçi | \x1b[1;31m Yakında 
\x1b[38;5;117m2\x1b[38;5;231m - Tiktok Beğeni | \x1b[1;31mYakında 
\x1b[38;5;117m3 \x1b[38;5;231m- Yorum Beğeni | \x1b[1;32mGüncel Aktıf ✅
\x1b[38;5;117m4 \x1b[38;5;231m- Tiktok İzlenme  | \x1b[1;32mGüncel Aktıf ✅
\x1b[38;5;117m5\x1b[38;5;231m - Tiktok Paylaşma  | \x1b[1;32mGüncel Aktıf ✅
\x1b[38;5;117m6 \x1b[38;5;231m- Tiktok Kaydetme  | \x1b[1;32mGüncel Aktıf ✅
\x1b[38;5;117m7 \x1b[38;5;231m- live-stream | \x1b[1;31mYakında""")
            print("\x1b[1;39m—" * 60)
            url1=input("~ Video linki Giriniz: ")
            self.url=url1
            print("—" * 60)
            print(f"-  SEÇİMİNİZ: ", end=' ')
        ...
        while True:
            ...
            try:
                if 'Service is currently not working, try again later' in str(self.use_service()):
                    print(f'{do}[\033[1;33m Hizmet şu anda kullanılamıyor, lütfen daha sonra tekrar deneyin ⌛.')
                    time.sleep(5)
            except Exception as e:
                print(f'CİDDİ HATA ❌| 10 saniye sonra tekrar deneyin.|| {e}')
                time.sleep(10)
